...
echo '<div class="card">';
echo '<h5 class="card-header border-bottom text-uppercase"><center>Scann File...</center></h5>';
echo '<center> <img src="https://i.ibb.co.com/3S896D8/seo.png"> </center> ';
echo '<div class="card-body">';
echo '<div class="alert bg-primary bg-gradient text-dark d-flex align-items-center" role="alert">';
echo '<i class="bx bx-info-circle fs-2 me-2"></i><center>FILE SCANNER BACKDOR AND MORE BY HUNTER SEO</center></div>';
echo "<a href='?kill'><font color='red'>❗ Delet All File...</font></a><br>";
...
function checkBackdoor($file_location){
    ...
    if(strlen($contents)> 0){
        if(preg_match($patern, strtolower($contents))){
            echo "❗ File Found...  <font color='red'>$file_location</font> <a href='?delete=$file_location&dir=$path'><font class='btn btn-primary bg-gradient waves-effect waves-light me-1' color='red'>🗑️ DELET FILE</font></a> <br>";
            save("files.txt","$file_location\n");
